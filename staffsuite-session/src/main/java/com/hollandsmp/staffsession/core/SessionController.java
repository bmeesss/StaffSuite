...
public final class SessionController {
    ...
    public CompletableFuture<InvestigationResult> startInvestigation(final UUID staffer, final UUID target, final InvestigationType type, final String reportId) {
